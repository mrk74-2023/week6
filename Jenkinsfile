pipeline {
  ...
  stages {
    ...
    stage('Push-Images-Docker-to-DockerHub') {
      steps {
        container('docker') {
          sh 'docker tag leszko/calculator:latest  mrk742023/demoproject:calculator-feature-v1.0-r0.1' 
          sh 'docker push  mrk742023/demoproject:calculator-feature-v1.0-r0.1'
      }
    }
    }
  }
