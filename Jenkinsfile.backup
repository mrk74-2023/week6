pipeline {
  ...
  stages {
    ...
    stage('Push-Images-Docker-to-DockerHub') {
      steps {
        container('docker') {
          sh 'docker tag leszko/calculator:latest mudassirmukhtar/demoproject:calculator-playground-v1.0-r0.1' 
          sh 'docker push mudassirmukhtar/demoproject:calculator-playground-v1.0-r0.1'
      }
    }
    }
  }
